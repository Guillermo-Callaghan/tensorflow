...
MatrixTriangularSolveOp::Broadcast(xla::XlaOp lhs, const TensorShape& lhs_shape,
  ...
  lhs_broadcast_shape.AddExpression(xla::DExpr::Const(m));
  lhs_broadcast_shape.AddDim(m);
  lhs_broadcast_shape.AddExpression(xla::DExpr::Const(m));
  auto lhs_output =
      BroadcastTo(lhs, lhs_broadcast_shape.dim_sizes(),
  ...
  rhs_broadcast_shape.AddExpression(xla::DExpr::Const(m));
  rhs_broadcast_shape.AddDim(n);
  rhs_broadcast_shape.AddExpression(xla::DExpr::Const(n));
  auto rhs_output =
      BroadcastTo(rhs, rhs_broadcast_shape.dim_sizes(),
